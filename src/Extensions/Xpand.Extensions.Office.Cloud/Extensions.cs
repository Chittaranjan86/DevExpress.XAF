...
namespace Xpand.Extensions.Office.Cloud{
    public static class Extensions{
        ...
        public static IObservable<(TCloudEntity serviceObject, MapAction mapAction)> ModifiedObjects<TLocalEntity, TCloudEntity>(this IObjectSpace objectSpace,SynchronizationType synchronizationType,
            Func<(CloudOfficeObject cloudOfficeObject,TLocalEntity localEntity), IObservable<(TCloudEntity serviceObject,MapAction mapAction)>> delete, Func<TLocalEntity, IObservable<(TCloudEntity serviceObject,MapAction mapAction)>> map){
